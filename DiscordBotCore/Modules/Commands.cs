    ...
    public class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        */
        ...
        public async Task MyStats()
        {
            ...
            await Context.Channel.SendMessageAsync(AlertsUtilities.GetFormattedAlert("MYSTATS_&XP_&PTS", account.XP, account.Points));
        }
        ...
        public async Task AddXp(uint xp)
        {
            ...
            await Context.Channel.SendMessageAsync(AlertsUtilities.GetFormattedAlert("GIVEXP_&NAME_&XP", Context.User.Username, xp));
